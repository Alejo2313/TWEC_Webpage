...
<div class="container">
    ...
    <form class="form-horizontal" action="/contact" method="GET" role="form" id="form">
        ...
        <div class="form-group">
            <div class="col-xs-offset-3 col-xs-9">
                <input type="submit" name="send" class="btn btn-login" id="Enviar" value="Enviar">
               <a href="/contact"> <input type="button" class="btn btn-login" id="Limpiar" value="Limpiar"></a>
            </div>
        </div>
